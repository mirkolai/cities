...
population = np.array([data[city]["population"] for city in italian_cities])
...
legend1 = plt.legend(title="Population", scatterpoints=1, labelspacing=0.5, loc='upper left', bbox_to_anchor=(0.02,1), handletextpad=1.5, frameon=False)
...
# Show plot
plt.savefig("plotting_AvsC_italiancities/plots/AvsC_italiancities_pop", dpi=600)
